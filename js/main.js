...
(function() {
  $(function() {
    var array1, array2, array3, array4, board, boardFull, collapseCells, generateTile, getColumn, getRow, masterArray, mergeCells, move, ppArray, randomIndex, randomValue, setColumn, setRow, x, y, _i, _j;
    ...
    move = function(board, direction) {
      var i, row, _k, _l, _results, _results1;
      switch (direction) {
        case 'right':
          _results = [];
        ...
        case 'left':
          ...
          for (i = _l = 3; _l >= 0; i = --_l) {
            ...
            _results1.push(setRow(row, i, board));
          }
          return _results1;
      }
    };
