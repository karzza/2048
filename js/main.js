...
(function() {
  $(function() {
    var array1, array2, array3, array4, board, boardFull, collapseCells, generateTile, getColumn, getRow, masterArray, mergeCells, ppArray, randomIndex, randomValue, setRow, x, y, _i, _j;
