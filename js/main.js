...
(function() {
  $(function() {
    var array1, array2, array3, array4, board, boardFull, collapseCells, generateTile, getColumn, getRow, masterArray, mergeCells, move, ppArray, randomIndex, randomValue, setColumn, setRow, showboard, x, y, _i, _j;
